        ...
        <ul>
          <li className='bg-blue-50 p-4 rounded shadow my-5'>
            <div>
              ...
              <a className='font-bold text-green-700' href='/use-example-1'>
                View
              </a>
            </div>
          </li>
          <li className='bg-blue-50 p-4 rounded shadow my-5'>
            <div>
              ...
              <a className='font-bold text-green-700' href='/use-example-2'>
                View
              </a>
            </div>
          </li>
          <li className='bg-blue-50 p-4 rounded shadow my-5'>
            <div>
              ...
              <a className='font-bold text-green-700' href='/use-example-3'>
                View
              </a>
            </div>
          </li>
          ...
          <li className='bg-blue-50 p-4 rounded shadow my-5'>
            <div>
              ...
              <a className='font-bold text-green-700' href='/action-example-1'>
                View
              </a>
            </div>
          </li>
          <li className='bg-blue-50 p-4 rounded shadow my-5'>
            <div>
              ...
              <a className='font-bold text-green-700' href='/action-example-2'>
                View
              </a>
            </div>
          </li>
